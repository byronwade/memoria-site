        ...
        <div className="text-center">
          ...
          >
            <a href="https://www.npmjs.com/package/@byronwade/memoria" target="_blank" rel="noopener noreferrer">
              <img src="https://img.shields.io/npm/v/@byronwade/memoria.svg" alt="npm version" className="h-5" />
            </a>
            <a href="https://github.com/byronwade/memoria" target="_blank" rel="noopener noreferrer">
              <img src="https://img.shields.io/github/stars/byronwade/memoria?style=social" alt="GitHub stars" className="h-5" />
            </a>
            <a href="https://smithery.ai/server/@byronwade/memoria" target="_blank" rel="noopener noreferrer">
              <img src="https://smithery.ai/badge/@byronwade/memoria" alt="Smithery" className="h-5" />
            </a>
          </motion.div>
          ...
          >
            The Memory Your AI{" "}
            <span className="text-accent">Lacks</span>
          </motion.h1>
          ...
          >
            <Card className="bg-gray-900 overflow-hidden shadow-xl border-gray-800 p-0">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-800">
                ...
                <span className="text-gray-500 text-xs font-mono ml-2">memoria</span>
              </div>
              <div className="p-4 text-left font-mono text-sm">
                <div className="text-gray-400">You: &quot;Update route.ts&quot;</div>
                <div className="mt-3 text-emerald-400">Memoria: Warning - 85% coupled with billing.tsx</div>
                ...
                <div className="mt-3 text-gray-400">AI: &quot;I&apos;ll update both files&quot;</div>
