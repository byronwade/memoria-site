	...
	return (
		<div className="docs-content">
			...
			<p>
				...
				depend on it &mdash; even if there&apos;s no direct import between them.
				Memoria prevents this by analyzing git history to find files that
    ...
    "memoria": {
      ...
      "args": ["-y", "@byronwade/memoria"]
			...
			<ul>
				...
				<li>
					<strong>Evidence</strong> &mdash; Actual code diffs showing why files
					are related
				</li>
			</ul>
			...
			<h2>Private & Local</h2>
			<p>
				Memoria runs <strong>100% on your machine</strong>. No code is uploaded
				to the cloud, no API keys required, works offline. Your code never
			...
			<ul>
				<li>
					...
					&mdash; Analyze a file to reveal risk score, coupled files, and hidden
					dependencies
				</li>
				<li>
					<strong>
