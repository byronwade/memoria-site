export default function ContributingPage() {
  return (
    <div className="docs-content">
      ...
      <ul>
        <li><strong>Report bugs</strong> &mdash; Found an issue? Open a GitHub issue</li>
        <li><strong>Suggest features</strong> &mdash; Have an idea? Start a discussion</li>
        <li><strong>Improve docs</strong> &mdash; Fix typos, add examples, clarify explanations</li>
        <li><strong>Submit code</strong> &mdash; Fix bugs or implement new features</li>
        <li><strong>Share feedback</strong> &mdash; Tell us how you use Memoria</li>
      </ul>
...
npm run format`}</code>
      ...
      <ol>
        <li>
          <strong>Fork the repository</strong> and create your branch from <code>main</code>
        </li>
        <li>
...
Cached Response to AI`}</code>
      ...
      <ol>
        <li>Create a new file in <code>src/engines/</code></li>
  ...
  // Implementation
      ...
      <ul>
        <li>
          ...
          <a href="https://github.com/byronwade/memoria/issues" target="_blank" rel="noopener noreferrer">
            Report bugs or request features
          </a>
        </li>
        <li>
          <strong>Discussions</strong> &mdash;{" "}
          <a href="https://github.com/byronwade/memoria/discussions" target="_blank" rel="noopener noreferrer">
