...
export default function SecurityPage() {
	return (
		<div className="docs-content">
			...
			<p>
				Memoria runs <strong>100% locally</strong> on your machine. It makes no
				network requests and requires no API keys, accounts, or cloud services.
			</p>
			...
			<ul>
				<li>
					<strong>Commit history</strong> &mdash; Messages, authors, timestamps,
					and file lists
				</li>
				<li>
			...
			<ul>
				<li>
					<code>.memoria.json</code> &mdash; Your project-specific configuration
				</li>
				<li>
			...
			<p>
				...
				data exists only in memory during your session. When you restart your AI
				tool, the cache is cleared.
			</p>

			<h2>Permission Model</h2>

			<p>
				Memoria runs with the same permissions as your AI tool (Claude Desktop,
				Cursor, etc.):
			</p>
			...
			<p>When using Memoria with an AI assistant, consider this trust chain:</p>
			...
			<ul>
				...
				<li>
					<strong>Use version control</strong> &mdash; Commit frequently so you
					can revert if needed
				</li>
				<li>
					<strong>Check sensitive files</strong> &mdash; Add sensitive files to
					your .gitignore and .memoria.json ignore patterns
				</li>
			</ul>
			...
			<ul>
				<li>
					<strong>Audit the source</strong> &mdash; Review the Memoria codebase
