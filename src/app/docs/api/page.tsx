	...
	return (
		<div className="docs-content">
			...
			<p>
				...
				Prompts, focusing instead on providing powerful analysis tools that work
				with any AI workflow.
			</p>
			...
			<div className="tool-card">
				...
				<ul>
					<li>
						<strong>Risk Score</strong> &mdash; Composite score (0-100) based on
						volatility, coupling, and drift
					</li>
					<li>
					...
					<li>
						<strong>Static Imports</strong> &mdash; Files that explicitly import
						the target
					</li>
					<li>
...
3. Run tests/stripe.test.ts after modifications`}</code>
			...
			<div className="tool-card">
				...
				<p>
					...
					the &ldquo;Chesterton&apos;s Fence&rdquo; problem &mdash;
					understanding the reason behind code before removing or modifying it.
				</p>
...
modifying rate limit values.`}</code>
			...
			<p>For MCP client developers, here are the JSON schemas for each tool:</p>
