export default function ApiPage() {
  return (
    <div className="docs-content">
      ...
      <p>
        Memoria is a tools-only MCP server. It does not expose Resources or Prompts,
        focusing instead on providing powerful analysis tools that work with any AI workflow.
      </p>
      ...
      <div className="tool-card">
        ...
        <p>
          Analyzes a file using git forensics to reveal hidden dependencies, risk factors,
          and coupled files. This is the primary tool for understanding code relationships.
        </p>
        ...
        <ul>
          <li><strong>Risk Score</strong> &mdash; Composite score (0-100) based on volatility, coupling, and drift</li>
          <li><strong>Volatility Analysis</strong> &mdash; Panic keyword frequency, bus factor, recent bug history</li>
          <li><strong>Coupled Files</strong> &mdash; Files that change together with coupling percentage</li>
          <li><strong>Stale Dependencies</strong> &mdash; Coupled files that are out of sync</li>
          <li><strong>Static Imports</strong> &mdash; Files that explicitly import the target</li>
...
3. Run tests/stripe.test.ts after modifications`}</code>
      ...
      <div className="tool-card">
        ...
        <p>
          ...
          &ldquo;Chesterton&apos;s Fence&rdquo; problem &mdash; understanding the reason
          behind code before removing or modifying it.
        </p>
        ...
        <ul>
          <li><strong>Matching Commits</strong> &mdash; Commits related to the query</li>
          <li><strong>Code Changes</strong> &mdash; Relevant diffs from those commits</li>
          <li><strong>Context</strong> &mdash; Commit messages explaining the changes</li>
          <li><strong>Authors</strong> &mdash; Who made the changes and when</li>
        </ul>
...
modifying rate limit values.`}</code>
  ...
  "inputSchema": {
    ...
    "required": ["query"]
      ...
      <p>
        Memoria formats output as structured text optimized for LLM consumption.
        The format includes:
      </p>

      <ul>
        <li><strong>Clear section headers</strong> using ASCII art dividers</li>
        <li><strong>Structured data</strong> in lists and tables</li>
        <li><strong>Actionable recommendations</strong> for the AI to follow</li>
        <li><strong>Evidence blocks</strong> with actual code diffs</li>
      </ul>
