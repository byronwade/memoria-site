...
memoria <command>`}</code>
			...
			<p>
				Initialize Memoria for your AI tools. Creates rule files for auto-pilot
				mode.
			</p>
  ...
  exit 1
			...
			<div className="callout callout-info">
				...
				<p>
					...
					the stdio transport and communicates via JSON-RPC. You don&apos;t need
					to interact with the CLI directly in this mode.
				</p>
			</div>
		</div>
	);
