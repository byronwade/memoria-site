...
export const alt = "Memoria Features";
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <span
              style={{ fontSize: "28px", fontWeight: 600, color: ogColors.foreground }}
            >
              Memoria
            </span>
          </div>
        ...
        >
          <span
            style={{ fontSize: "18px", color: ogColors.mutedForeground, display: "flex" }}
          >
            The Memory Your AI{" "}
            <span style={{ color: ogColors.accent, marginLeft: "6px" }}>Lacks</span>
          </span>
          <span style={{ fontSize: "16px", color: "#737373" }}>memoria.dev</span>
        </div>
      </div>
    ),
    {
      ...size,
      fonts: [
        { name: "Geist", data: geistFont, style: "normal", weight: 400 },
        { name: "Geist", data: geistFont, style: "normal", weight: 600 },
      ],
    }
  );
}
