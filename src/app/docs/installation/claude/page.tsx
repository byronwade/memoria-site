...
export default function ClaudePage() {
  return (
    <div className="docs-content">
      ...
      <p>
        Press <kbd>Win + R</kbd>, type <code>%APPDATA%\Claude</code>, and press Enter.
      </p>

      <h2>Step 2: Add Memoria to Config</h2>

      <p>Open (or create) <code>claude_desktop_config.json</code> and add:</p>
  ...
  "mcpServers": {
    "memoria": {
      ...
      <p>
        If you already have other MCP servers configured, add memoria to the existing
  ...
  "mcpServers": {
    ...
    "memoria": {
      ...
      <p>
        You should see <code>analyze_file</code> and <code>ask_history</code> from Memoria listed.
      </p>
      ...
      <pre className="code-inline">
        <code>&quot;Analyze /Users/me/project/src/api/route.ts before I refactor it&quot;</code>
      </pre>

      <div className="callout callout-warning">
        <h4>Important: Use Absolute Paths</h4>
        <p>
          Memoria requires absolute file paths (e.g., <code>/Users/me/project/src/file.ts</code>).
