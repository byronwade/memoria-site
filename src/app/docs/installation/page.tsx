...
export default function InstallationPage() {
      ...
      <div className="grid gap-3 mt-6">
        {guides.map((guide) => (
          ...
          >
            ...
            <p className="text-muted-foreground text-sm mt-1 mb-0">{guide.description}</p>
          </Link>
        ))}
      </div>
  ...
  "mcpServers": {
    "memoria": {
      ...
      <p>
        You should see <code>analyze_file</code> and <code>ask_history</code> from Memoria in the response.
      </p>
    </div>
  );
}
