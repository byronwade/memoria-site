...
export default function ContinuePage() {
  return (
    <div className="docs-content">
      ...
      <p>
        Continue uses a slightly different config format. Add the following to your <code>config.json</code>:
      </p>
  ...
  "experimental": {
    "modelContextProtocolServers": [
      ...
      <p>
        If you have an existing config, merge the <code>experimental</code> section:
      </p>
  ...
  "experimental": {
    "modelContextProtocolServers": [
      ...
      <p>
        Reload your VS Code window (<kbd>Cmd/Ctrl + Shift + P</kbd> &rarr; &quot;Developer: Reload Window&quot;).
      </p>
      ...
      <div className="callout callout-info">
        ...
        <p>
          MCP support in Continue is marked as experimental. Check Continue&apos;s
          documentation for the latest configuration format.
        </p>
      </div>
    </div>
  );
