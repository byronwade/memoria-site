	...
	return (
		<div className="docs-content">
			...
			<p>
				...
				matter more than old ones. Also tracks <strong>Bus Factor</strong> (who
				owns the code).
			</p>
			...
			<p>
				<strong>High panic score = historically bug-prone code.</strong> The AI
				is instructed to review changes twice and avoid removing safety checks.
			</p>
			...
			<ol>
				<li>
					For each commit that touched the target file, find all other files in
					that commit
				</li>
				<li>Count how often each file appears alongside the target</li>
				<li>
					Calculate coupling percentage: <code>(co-changes / total) * 100</code>
				</li>
			...
			<p>
				...
				the &ldquo;Chesterton&apos;s Fence&rdquo; problem before you delete that
				weird-looking code.
			</p>
