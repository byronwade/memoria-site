...
export default function AutoPilotPage() {
	return (
		<div className="docs-content">
			...
			<p className="lead">
				Make your AI automatically analyze files before modifying them&mdash;no
				prompting required.
			</p>
			...
			<p>
				Auto-Pilot mode injects custom rules into your AI tool that instruct it
				to automatically call Memoria&apos;s <code>analyze_file</code> function
				before making any changes to a file. This ensures your AI always has
				context about file dependencies and risks.
			</p>
