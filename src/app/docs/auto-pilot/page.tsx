...
export default function AutoPilotPage() {
  return (
    <div className="docs-content">
      ...
      <p className="lead">
        Make your AI automatically analyze files before modifying them&mdash;no prompting required.
      </p>

      <h2>What is Auto-Pilot Mode?</h2>

      <p>
        Auto-Pilot mode injects custom rules into your AI tool that instruct it to
        automatically call Memoria&apos;s <code>analyze_file</code> function before making
        any changes to a file. This ensures your AI always has context about file
      ...
      <p>
        Run the init command with the <code>--all</code> flag to set up rules for all
        supported AI tools:
      </p>
...
npx @byronwade/memoria init --cline`}</code>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Cursor</td>
            <td><code>.cursor/rules/memoria.mdc</code></td>
          </tr>
          <tr>
            <td>Claude Code</td>
            <td><code>.claude/memoria.md</code></td>
          </tr>
          <tr>
            <td>Windsurf</td>
      ...
      <ol>
        <li>Call <code>analyze_file</code> before modifying any source file</li>
        <li>Review the risk score and coupled files in the response</li>
        <li>Update coupled files if they share type definitions or schemas</li>
...
Then review the output before making changes.`}</code>
      ...
      <p>
        Without flags, this command scans for existing AI tool configurations and
        offers to set up rules for detected tools.
      </p>

      <h2>Customizing Rules</h2>

      <p>
        After running init, you can customize the generated rule files. For example,
        you might want to:
      </p>
      ...
      <div className="callout callout-warning">
        ...
        <p>
          If you delete the rule files, your AI will no longer automatically call
          Memoria. You&apos;ll need to manually ask it to analyze files.
        </p>
      </div>
      ...
      <ol>
        ...
        <li>Ask the AI to modify a file: &quot;Update src/api/route.ts to add logging&quot;</li>
        <li>Watch for the AI to call <code>analyze_file</code> before making changes</li>
      </ol>

      <p>
        If the AI doesn&apos;t automatically analyze, check that the rule file is in the
        correct location and restart your AI tool.
      </p>
