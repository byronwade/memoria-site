...
export default function ConfigurationPage() {
  return (
    <div className="docs-content">
      ...
      <p className="lead">
        Customize Memoria&apos;s behavior with a <code>.memoria.json</code> configuration file.
      </p>

      <h2>Creating a Config File</h2>

      <p>
        Create a <code>.memoria.json</code> file in your project root to customize thresholds,
        ignore patterns, and risk weights.
      </p>
  ...
  "riskWeights": {
    ...
    "panic": 0.3
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td><code>couplingPercent</code></td>
            <td>60</td>
            <td>Minimum co-change percentage to flag files as coupled</td>
          </tr>
          <tr>
            <td><code>driftDays</code></td>
            <td>14</td>
            <td>Days since last modification to consider a file &quot;stale&quot;</td>
          </tr>
          <tr>
            <td><code>analysisWindow</code></td>
            <td>90</td>
      ...
      <p>
        The <code>ignore</code> array uses glob patterns to exclude files from analysis:
      </p>
  ...
  "ignore": [
    ...
    "*.d.ts"
      ...
      <p>
        Customize the keywords that contribute to a file&apos;s &quot;panic score&quot;. These
        indicate areas of technical debt or instability:
      </p>
  ...
  "panicKeywords": [
    ...
    "DEPRECATED"
      ...
      <p>
        Adjust how different factors contribute to the overall risk score. Weights should
        sum to 1.0:
      </p>
  ...
  "riskWeights": {
    ...
    "panic": 0.3
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td><code>MEMORIA_DEBUG</code></td>
            <td>Enable debug logging (set to &quot;true&quot;)</td>
          </tr>
          <tr>
            <td><code>MEMORIA_CONFIG</code></td>
      ...
      <p>
        Each project can have its own <code>.memoria.json</code>. Memoria automatically
        detects and uses the config file in the current working directory.
      </p>

      <div className="callout callout-info">
        <h4>Config Priority</h4>
        <p>
          Project-level config (<code>.memoria.json</code>) takes precedence over
