  ...
  return (
    <div className="docs-content">
      ...
      <div className="callout callout-info">
        ...
        <p>
          Watch the{" "}
          <a href="https://github.com/byronwade/memoria/releases" target="_blank" rel="noopener noreferrer">
            GitHub Releases
          </a>{" "}
      ...
      <ul>
        <li>
          <strong>analyze_file</strong> tool &mdash; Core file analysis with git forensics
          <ul>
            <li>Volatility Engine: Panic keyword detection with time-decay scoring</li>
            <li>Entanglement Engine: Co-change analysis with configurable threshold</li>
        ...
        <li>
          <strong>ask_history</strong> tool &mdash; Git history search for understanding code context
        </li>
        <li>
          <strong>CLI commands</strong>
          <ul>
            <li><code>memoria init</code> &mdash; Auto-setup for AI tools</li>
            <li><code>memoria analyze</code> &mdash; Standalone file analysis</li>
            <li><code>memoria serve</code> &mdash; Start MCP server</li>
          </ul>
        </li>
        <li>
          <strong>Configuration</strong> via <code>.memoria.json</code>
          <ul>
            <li>Customizable thresholds (coupling, drift, analysis window)</li>
        ...
        <li>
          <strong>Auto-pilot mode</strong> &mdash; Automatic analysis rules for AI tools
          <ul>
            <li>Cursor rules (<code>.cursor/rules/memoria.mdc</code>)</li>
            <li>Claude Code rules (<code>.claude/memoria.md</code>)</li>
            <li>Windsurf rules (<code>.windsurfrules</code>)</li>
            <li>Cline rules (<code>.clinerules</code>)</li>
          </ul>
        </li>
        <li>
          ...
          <ul>
            ...
            <li>Smart filtering of noise (node_modules, build artifacts, etc.)</li>
...
PATCH - Bug fixes (backward compatible)`}</code>
      ...
      <ul>
        ...
        <li>Changes to default behavior that could affect existing workflows</li>
...
memoria --version`}</code>
      ...
      <div className="callout callout-warning">
        ...
        <p>
          Before upgrading to a new major version, read the release notes for any
          migration steps. Breaking changes will be clearly documented.
        </p>
      </div>
    </div>
  );
